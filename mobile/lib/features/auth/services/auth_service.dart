...
class AuthService {
  ...
  Future<String> register({
    ...
    return ApiPayloadParser.extractMessage(
      response.data,
      fallback: 'Đăng ký thành công.',
    );
  }
  ...
  Future<String> verifyEmail({
    ...
    return ApiPayloadParser.extractMessage(
      response.data,
      fallback: 'Xác thực email thành công.',
    );
  }
  ...
  Future<String> resendVerification({required String email}) async {
    ...
    return ApiPayloadParser.extractMessage(
      response.data,
      fallback: 'Mã xác thực đã được gửi lại.',
    );
  }
  ...
  Future<TokenResponse> loginWithPassword({
    ...
    return TokenResponse.fromJson(
      ApiPayloadParser.requireObject(
        response.data,
        errorMessage: 'Invalid token response from server',
      ),
    );
  }
  ...
  Future<UserInfo> fetchCurrentUser() async {
    ...
    return UserInfo.fromJson(
      ApiPayloadParser.requireObject(
        response.data,
        errorMessage: 'Invalid user response from server',
      ),
    );
  }
